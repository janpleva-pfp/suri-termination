...
const jestConfigOverride = {
  ...
  moduleNameMapper: {
    '^@app/(.*)$': '<rootDir>/$1',
    // Force module uuid to resolve with the CJS entry point, because Jest does not support
    // package.json.exports. See https://github.com/uuidjs/uuid/issues/451
  ...
  // 1 as the maximum worker number.
  ...
  modulePathIgnorePatterns: ['mock-data'],
  ...
  // module loader will automatically
